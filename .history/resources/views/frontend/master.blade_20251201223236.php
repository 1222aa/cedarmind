    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-20 md:h-24">
        ...
        <div class="hidden md:flex md:items-center md:space-x-3">
          ...
          <a href="\signup.blade.php" class="brand-cta px-3 py-1.5 rounded text-sm">Get Started</a>
        </div>
        ...
        <svg class="w-full h-full" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 600">
          <defs>
            <linearGradient id="g1" x1="0%" x2="100%" y1="0%" y2="100%">
              <stop offset="0%" stop-color="var(--cedar)" stop-opacity="0.95"/>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div class="mt-8 flex flex-wrap gap-3">
              <a href="signup.html" class="brand-cta px-5 py-3 rounded-md shadow">Get Started</a>
              <a href="courses.html" class="brand-outline px-5 py-3 rounded-md">Explore Courses</a>
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><a href="#blog" class="opacity-80 hover:opacity-100 transition">Blog</a></li>
            <li><a href="#help" class="opacity-80 hover:opacity-100 transition">Help Center</a></li>
            <li><a href="#faq" class="opacity-80 hover:opacity-100 transition">FAQ</a></li>
            <li><a href="#community" class="opacity-80 hover:opacity-100 transition">Community</a></li>
          </ul>
        </div>
