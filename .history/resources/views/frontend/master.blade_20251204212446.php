      ...
      <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition">
          <div class="flex items-center justify-between mb-2">
            <h3 class="font-semibold text-[var(--cedar)]">Object-Oriented Programming</h3>
          ...
          <p class="mt-3 text-xs text-slate-500">📚 3 Lessons • 🎯 Intermediate • ⏱️ 25 hours</p>
        </div>
        <div class="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition">
          <div class="flex items-center justify-between mb-2">
          ...
          <p class="mt-3 text-xs text-slate-500">📚 3 Lessons • 🎯 Intermediate • ⏱️ 30 hours</p>
        </div>
        <div class="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition">
          <div class="flex items-center justify-between mb-2">
            <h3 class="font-semibold text-[var(--cedar)]">Database Design & SQL</h3>
            <i class="fas fa-database text-[var(--cedar-light)]"></i>
          </div>
          <p class="mt-2 text-sm text-slate-600">Master relational databases, normalization, SQL queries, and database optimization.</p>
          <p class="mt-3 text-xs text-slate-500">📚 3 Lessons • 🎯 Beginner-Intermediate • ⏱️ 28 hours</p>
        </div>
      </div>
    </section>
  </main>
