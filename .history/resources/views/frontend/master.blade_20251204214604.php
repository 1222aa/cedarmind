...
<body class="bg-gray-50 text-gray-900 font-sans">
  ...
  <main class="container-main">
    ...
    <section class="py-20 px-6 max-w-6xl mx-auto">
     ...
     <section class="py-20 px-6 max-w-6xl mx-auto">
      <div class="text-center mb-12">
        <h2 class="text-4xl font-bold brand-heading">Featured Courses</h2>
        <p class="mt-3 text-lg text-slate-600 max-w-2xl mx-auto">Start learning with our most popular courses. Built by experts, for students.</p>
      </div>
      <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="group bg-white rounded-xl shadow-md hover:shadow-2xl transition duration-300 overflow-hidden border border-gray-100">
          <div class="h-48 bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center relative overflow-hidden">
            <div class="absolute inset-0 bg-black/10 group-hover:bg-black/20 transition"></div>
            <i class="fas fa-code text-white text-6xl opacity-80 group-hover:scale-110 transition transform"></i>
          </div>
          <div class="p-6">
            <h3 class="font-bold text-lg text-gray-900">Object-Oriented Programming</h3>
            ...
            <a href="/courses" class="mt-4 block w-full text-center py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 font-semibold rounded-lg transition">View Course</a>
          </div>
        </div>

        <div class="group bg-white rounded-xl shadow-md hover:shadow-2xl transition duration-300 overflow-hidden border border-gray-100">
          <div class="h-48 bg-gradient-to-br from-green-600 to-green-400 flex items-center justify-center relative overflow-hidden">
            <div class="absolute inset-0 bg-black/10 group-hover:bg-black/20 transition"></div>
            <i class="fas fa-database text-white text-6xl opacity-80 group-hover:scale-110 transition transform"></i>
          </div>
          <div class="p-6">
            <h3 class="font-bold text-lg text-gray-900">Database Design & SQL</h3>
            <p class="mt-2 text-sm text-slate-600">Master relational databases, normalization, SQL queries, and optimization.</p>
            <div class="mt-4 flex items-center justify-between text-xs text-slate-500">
              <span>📚 3 Lessons</span>
              <span>⏱️ 28 hours</span>
            </div>
            <a href="/courses" class="mt-4 block w-full text-center py-2 bg-green-50 hover:bg-green-100 text-green-600 font-semibold rounded-lg transition">View Course</a>
          </div>
        </div>

        <div class="group bg-white rounded-xl shadow-md hover:shadow-2xl transition duration-300 overflow-hidden border border-gray-100">
          <div class="h-48 bg-gradient-to-br from-purple-600 to-purple-400 flex items-center justify-center relative overflow-hidden">
            <div class="absolute inset-0 bg-black/10 group-hover:bg-black/20 transition"></div>
            <i class="fas fa-network-wired text-white text-6xl opacity-80 group-hover:scale-110 transition transform"></i>
          </div>
          <div class="p-6">
            <h3 class="font-bold text-lg text-gray-900">Computer Networks</h3>
            <p class="mt-2 text-sm text-slate-600">Learn networking fundamentals, TCP/IP protocols, routing, and security.</p>
            <div class="mt-4 flex items-center justify-between text-xs text-slate-500">
              <span>📚 3 Lessons</span>
              <span>⏱️ 30 hours</span>
            </div>
            <a href="/courses" class="mt-4 block w-full text-center py-2 bg-purple-50 hover:bg-purple-100 text-purple-600 font-semibold rounded-lg transition">View Course</a>
          </div>
        </div>
      </div>
    </section>
