...
<body class="bg-gray-50 text-gray-900 font-sans">
  ...
  <script>
    ...
    function displayCourses(courses) {
      ...
      // Course icons and colors based on course type
      const courseStyles = {
        'Object-Oriented Programming': { icon: 'fa-python', gradient: 'from-blue-600 to-blue-400', bgColor: 'bg-blue-50' },
        'Database Design and SQL': { icon: 'fa-database', gradient: 'from-green-600 to-green-400', bgColor: 'bg-green-50' },
        'Computer Networks': { icon: 'fa-network-wired', gradient: 'from-purple-600 to-purple-400', bgColor: 'bg-purple-50' },
      };
      ...
      courses.forEach((course, index) => {
        ...
        // Get styles for this course, fallback to cedar colors
        const styles = courseStyles[course.title] || { icon: 'fa-book', gradient: 'from-[var(--cedar)] to-[var(--cedar-light)]', bgColor: 'bg-gray-50' };
        
        courseCard.innerHTML = `
          <div class="h-40 bg-gradient-to-br ${styles.gradient} flex items-center justify-center">
            <i class="fas ${styles.icon} text-white text-5xl opacity-80"></i>
          </div>
          <div class="p-6">
